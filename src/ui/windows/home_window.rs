use eframe::egui::*;
use crate::{models::{cost_item::{CostCycle, ExpenceCategory}, income_item::{IncomeCategory, IncomeItem}}, ui::components::{quick_add_expense::QuickAddExpense, quick_add_income::QuickAddIncome}, AppEvent, BudgetData};
                ...
                right_expenses.vertical(|right|{
                    ...
                    if budget_data.cost_items.is_empty() {
                        ...
                        ScrollArea::vertical()
                            ...
                            .max_height(scroll_height)
                            .show(right, |ui| {
                                for (i, item) in budget_data.cost_items.values().enumerate() {
                                    ui.horizontal(|ui| {
                                        ui.label(&item.what);
